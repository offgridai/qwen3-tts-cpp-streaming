...
function Resolve-CliExe {
    ...
    $defaultCli = Join-Path $PSScriptRoot "..\build\tts_engine_cli.exe"
...
function Resolve-OriginalCliExe {
    ...
    $defaultOriginalCli = Join-Path $PSScriptRoot "..\third_party\qwen3-tts-original.cpp\build-cuda-ninja\tts_engine_cli.exe"
