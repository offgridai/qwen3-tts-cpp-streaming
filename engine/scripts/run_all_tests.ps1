...
$cliExe = Resolve-BinaryPath -name "tts_engine_cli" -buildDir $resolvedBuildDir -config $Configuration
...
if (-not $cliExe) {
    Add-Skip "CLI output tests (tts_engine_cli binary missing)"
...
if (-not $run17B) {
    ...
    Add-Skip "1.7B CLI output tests (tts_engine_cli binary missing)"
