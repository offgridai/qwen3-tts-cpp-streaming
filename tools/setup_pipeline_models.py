...
def main() -> int:
    ...
    if wants_coreml:
        ...
        eprint("  ./build/tts_engine_cli -m models -t \"Hello\" -o out.wav")
        eprint("  # Optional override path:")
        eprint("  QWEN3_TTS_COREML_MODEL=models/coreml/code_predictor.mlpackage ./build/tts_engine_cli -m models -t \"Hello\" -o out.wav")
    else:
        eprint("\nRun without CoreML:")
        eprint("  ./build/tts_engine_cli -m models -t \"Hello\" -o out.wav")
